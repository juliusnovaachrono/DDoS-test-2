...
//    headless: true,
    ...
    targetFilter: (target) => !!target.url(), // targetFilter 
    headless: "new",
    // Set level 'info' and 'debug'
    logLevel: 'debug', // and 'debug'
}).then(async browser => {
...
//    await page.goto('https://nowsecure.nl')
    ...
    // Click on the blank content
    await page.click('body')

    await page.waitForTimeout(1000)

    // Simulate pressing the Tab key several times until the focus reaches the check box
    await page.keyboard.press('Tab')
    // await page.keyboard.press('Tab')

    await page.waitForTimeout(1000)

    // Simulate pressing the Space key to select the check box
